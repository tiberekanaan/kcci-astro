...
export interface ApiExecutiveMemberExecutiveMember
  extends Struct.CollectionTypeSchema {
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide settings such as the site name and global navigation.';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'The KCCI landing page composed of dynamic content blocks.';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Generic content page composed of dynamic content blocks.';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPressReleasePressRelease
  ...
  info: {
    description: 'KCCI press releases and announcements.';
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Downloadable documents, external links, and videos.';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['Document', 'Link', 'Video']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::executive-member.executive-member': ApiExecutiveMemberExecutiveMember;
